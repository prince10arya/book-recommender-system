"""
preprocessing_service/app/config/error_handler.py
---------------------------------------------------
Global exception handler registration for the Preprocessing Service.

Registers:
  - AppException  → unified {"success": false, "error": "..."} JSON response
